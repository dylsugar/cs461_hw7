...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1092:	48 be 34 1e 00 00 00 	movabs $0x1e34,%rsi
    1099:	00 00 00 
...
print_x64(int fd, addr_t x)
{
  ...
  for (i = 0; i < (sizeof(addr_t) * 2); i++, x <<= 4)
    ...
    1578:	48 ba 80 21 00 00 00 	movabs $0x2180,%rdx
    157f:	00 00 00 
...
print_x32(int fd, uint x)
{
  ...
  for (i = 0; i < (sizeof(uint) * 2); i++, x <<= 4)
    ...
    15d4:	48 b8 80 21 00 00 00 	movabs $0x2180,%rax
    15db:	00 00 00 
...
print_d(int fd, int v)
{
  ...
  do {
    ...
    1678:	48 b9 80 21 00 00 00 	movabs $0x2180,%rcx
    167f:	00 00 00 
...
printf(int fd, char *fmt, ...)
{
  ...
  for (i = 0; (c = fmt[i] & 0xff) != 0; i++) {
    ...
    1852:	00 
    1853:	48 b8 58 1e 00 00 00 	movabs $0x1e58,%rax
    185a:	00 00 00 
    ...
    1a31:	75 41                	jne    1a74 <printf+0x36e>
        s = "(null)";
    1a33:	48 b8 50 1e 00 00 00 	movabs $0x1e50,%rax
    1a3a:	00 00 00 
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1b32:	48 b8 b0 21 00 00 00 	movabs $0x21b0,%rax
    1b39:	00 00 00 
  ...
  freep = p;
    1c38:	48 ba b0 21 00 00 00 	movabs $0x21b0,%rdx
    1c3f:	00 00 00 
...
morecore(uint nu)
{
  ...
  return freep;
    1cbc:	48 b8 b0 21 00 00 00 	movabs $0x21b0,%rax
    1cc3:	00 00 00 
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1ceb:	48 b8 b0 21 00 00 00 	movabs $0x21b0,%rax
    1cf2:	00 00 00 
    ...
    1d03:	48 b8 a0 21 00 00 00 	movabs $0x21a0,%rax
    1d0a:	00 00 00 
    1d0d:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1d11:	48 ba b0 21 00 00 00 	movabs $0x21b0,%rdx
    1d18:	00 00 00 
    1d1b:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1d1f:	48 89 02             	mov    %rax,(%rdx)
    1d22:	48 b8 b0 21 00 00 00 	movabs $0x21b0,%rax
    1d29:	00 00 00 
    1d2c:	48 8b 00             	mov    (%rax),%rax
    1d2f:	48 ba a0 21 00 00 00 	movabs $0x21a0,%rdx
    1d36:	00 00 00 
    1d39:	48 89 02             	mov    %rax,(%rdx)
    base.s.size = 0;
    1d3c:	48 b8 a0 21 00 00 00 	movabs $0x21a0,%rax
    1d43:	00 00 00 
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1dab:	89 50 08             	mov    %edx,0x8(%rax)
      ...
      freep = prevp;
    1dae:	48 ba b0 21 00 00 00 	movabs $0x21b0,%rdx
    1db5:	00 00 00 
    ...
    if(p == freep)
    1dc9:	48 b8 b0 21 00 00 00 	movabs $0x21b0,%rax
    1dd0:	00 00 00 
